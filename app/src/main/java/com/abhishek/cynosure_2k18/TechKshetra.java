...
public class TechKshetra extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tech_kshetra);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {Intent myMail = new Intent(Intent.ACTION_SEND);
                ...
                String to="rakshasao@gmail.com";
                String sub="Regarding TECHKSHETRA";
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+918446912037"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+918698286931"));
        startActivity(intent);
    }
