...
public class Motustron extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_motustron);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {Intent myMail = new Intent(Intent.ACTION_SEND);
                ...
                String to="saketsghate@gmail.com";
                String sub="Regarding Motustron";
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+918983924766"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+917276717660"));
        startActivity(intent);
    }
