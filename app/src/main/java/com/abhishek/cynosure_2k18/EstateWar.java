...
public class EstateWar extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estate_war);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {Intent myMail = new Intent(Intent.ACTION_SEND);
                ...
                String to="ssshankare01@gmail.com";
                String sub="Regarding EstateWar";
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+919096766264"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+919960204085"));
        startActivity(intent);
    }
