...
public class ProgChamp extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prog_champ);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {Intent myMail = new Intent(Intent.ACTION_SEND);
                ...
                String to="snaily16@gmail.com";
                String sub="Regarding ProgChamp";
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+919975226167"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+919769748955"));
        startActivity(intent);
    }
