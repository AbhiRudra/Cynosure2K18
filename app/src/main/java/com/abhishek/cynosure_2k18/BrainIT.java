...
public class BrainIT extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_brain_it);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {Intent myMail = new Intent(Intent.ACTION_SEND);
                ...
                String to="patilniraj67@gmail.com";
                String sub="Regarding BrainIT";
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+919763047404"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+917378908397"));
        startActivity(intent);
    }
